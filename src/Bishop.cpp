...
/*==============================================================================
  ...
  moves
  ==============================================================================*/
bitboard Bishop::get_moves(uint square, Piece::Player player, const IBoard *board) const
{
    bitboard attacks = 0;
...
/*==============================================================================
  ...
  board is empty.
  ==============================================================================*/
bitboard Bishop::get_diagonal_ray_from(BoardSquare square, Diagonal direction) const
{
    if (IBoard::is_inside_board(square))
