...
bool UserCommand::load_commands()
{
...
bool UserCommand::is_quit() const
{
    return this->key == QUIT;
}

bool UserCommand::is_move() const
{
    return this->key == MOVE;
}

UserCommand::CommandKey UserCommand::get_key() const
{
    return this->key;
}

string UserCommand::get_notation() const
{
