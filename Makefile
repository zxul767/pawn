...
# COMPILATION
$(OBJ_DIR)/%.o: $(SRC_DIR)/%.$(SOURCE_EXT) $(DEP_DIR)/%.$(DEP_EXT)
...
# compilation
$(UNIT_TEST_OBJ_DIR)/%.o: $(UNIT_TEST_SRC_DIR)/%.$(SOURCE_EXT) $(DEP_DIR)/%.$(DEP_EXT)
...
# COMPILATION
$(PERF_TEST_OBJ_DIR)/%.o: $(PERF_TEST_SRC_DIR)/%.$(SOURCE_EXT) $(DEP_DIR)/%.$(DEP_EXT)
...
all: ensure_folders $(BIN_DIR)/$(PROJECT)

rebuild: clean all

perf_test: ensure_folders $(PERF_TEST_BIN_DIR)/$(PERF_TEST_PROJECT)
	@echo "$(INFO_COLOR)Running performance tests ...$(NO_COLOR)"
	./$(PERF_TEST_BIN_DIR)/$(PERF_TEST_PROJECT)

unit_test: ensure_folders $(UNIT_TEST_BIN_DIR)/$(UNIT_TEST_PROJECT)
