...
class MaeBoard : public Board
{
 public:
   ...
   bool add_piece (const string& location, 
                   Piece::Type type,
                   Piece::Player player);

   bool add_piece (Squares square,
                   Piece::Type type,
                   Piece::Player player);
   ...
   bitboard threats_to (Squares location, Piece::Type type,
                        bool include_king) const;
   ...
   bitboard get_pieces (Piece::Player player, 
   ...
   void set_castling_privilege (Piece::Player player, 
                                CastleSide side, bool value);
